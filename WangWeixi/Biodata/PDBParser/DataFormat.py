...
"""
  Author:  H.Wang
  Purpose: Describe the PDB data format.
  Created: 5/2/2019
"""
...
class DataFormat:
    """
    Create the readable format for the files offered by PDB, etc. *.ent, *.pdb, *.xml ...
    """
    @property
    def txt_based_data(self):
        ...
        pdb_format.update(HEADER=dict(classification=dict(start=[11], end=[50], datatype=str, description='Classifies the molecule(s).'),
                                    ...
                                    idCode=dict(start=[63], end=[66], datatype=str, description='This identifier is unique within the PDB.')))
        ...
        pdb_format.update(CAVEAT=dict(continuation=dict(start=[9], end=[10], datatype=str, description='Allows for multiple ID codes.'),
                                    idCode=dict(start=[12], end=[15], datatype=str, description='PDB ID code of this entry.'),
        ...
        pdb_format.update(DBREF=dict(idCode=dict(start=[8], end=[11], datatype=str, description='ID code of this entry.'),
                                    ...
                                    seqBegin=dict(start=[15], end=[18], datatype=int, description='Initial sequence number of the PDB sequence segment.'),
                                    insertBegin=dict(start=[19], end=[19], datatype=str, description='Initial  insertion code of the PDB  sequence segment.'),
                                    seqEnd=dict(start=[21], end=[24], datatype=int, description='Ending sequence number of the PDB  sequence segment.'),
                                    insertEnd=dict(start=[25], end=[25], datatype=str, description='Ending insertion code of the PDB  sequence segment.'),
                                    ...
                                    idbnsBeg=dict(start=[61], end=[61], datatype=str, description='Insertion code of initial residue of the segment, if PDB is the reference.'),
                                    dbseqEnd=dict(start=[63], end=[67], datatype=int, description='Ending sequence number of the database segment.'),
                                    dbinsEnd=dict(start=[68], end=[68], datatype=str, description='Insertion code of the ending residue of the segment, if PDB is the reference.'),
                                      ))

        pdb_format.update(SEQADV=dict(idCode=dict(start=[8], end=[11], datatype=str, description='ID code of this entry.'),
                                    resName=dict(start=[13], end=[15], datatype=str, description='Name of the PDB residue in conflict.'),
                                    chainID=dict(start=[17], end=[17], datatype=str, description='PDB  chain identifier.'),
                                    seqNum=dict(start=[19], end=[22], datatype=int, description='PDB  sequence number.'),
                                    iCode =dict(start=[23], end=[23], datatype=str, description='PDB insertion code.'),
        ...
        pdb_format.update(DBREF1=dict(idCode=dict(start=[8], end=[11], datatype=str, description='ID code of this entry.'),
                                      chainID=dict(start=[13], end=[13], datatype=str, description='Chain identifier.'),
                                      seqBegin=dict(start=[15], end=[18], datatype=int, description='Initial sequence number of the PDB sequence segment, right justified.'),
                                      insertBegin=dict(start=[19], end=[19], datatype=str, description='Initial insertion code of the PDB sequence segment.'),
                                      seqEnd=dict(start=[21], end=[24], datatype=int, description='Ending sequence number of the PDB sequence segment, right justified.'),
                                      insertEnd=dict(start=[25], end=[25], datatype=str, description='Ending insertion code of the PDB sequence  segment.'),
                                      database=dict(start=[27], end=[32], datatype=str, description='Sequence database name.'),
